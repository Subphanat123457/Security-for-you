...
function CardContentsNetwork() {
  ...
  return (
    ...
    <div className="sm:p-14">
      <h1 className="text-4xl font-bold text-center">Network</h1>
        ...
        {data.Network.map((item, index) => (
          <Card
            ...
            onClick={(event) => {
              ...
              handleNavigation(event, 'PageDiscriptionNetwork');
            }}
          >
...
export default CardContentsNetwork;