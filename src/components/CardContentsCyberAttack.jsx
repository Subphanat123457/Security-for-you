...
function CardContentsCyberAttack() {
  ...
  return (
    ...
    <div className="sm:p-14">
      <h1 className="text-4xl font-bold text-center">Cyber Attack</h1>
        ...
        {data.Attack.map((item, index) => (
          <Card
            ...
            onClick={(event) => {
              ...
              handleNavigation(event, 'PageDiscriptionAttack');
            }}
          >
...
export default CardContentsCyberAttack;